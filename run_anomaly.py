...
from utils.ccm_tad_anomaly_evaluation.combined_results import getCombinedResult
from utils.config_loader import config_update
from utils.tools import save_result_to_excel
...
def main():
    ...
    parser.add_argument('--model', type = str, required = False, default = 'CCM_TAD', choices = ['CCM_TAD'], help = 'model of experiment')
    ...
    # Data Specific
    parser.add_argument('--data', type = str, default = 'PSM', choices = ['SWAT', 'PSM', 'WADI', 'SMAP','SMD', 'MSL', 'SMAP_Combined', 'MSL_Combined', 'SMD_Combined'], help = 'dataset')
