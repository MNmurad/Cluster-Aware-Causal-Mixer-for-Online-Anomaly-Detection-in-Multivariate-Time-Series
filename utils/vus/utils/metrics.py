...
class metricor:
    ...
    def RangeAUC_volume(self, labels_original, score, windowSize, evidence = None, start_end_update = False, thre = 250):
        """
            ...
            Our proposed sequential anomaly detection has additional start and end point correction method, which requires evidence(beta_t)
            If you don't use our proposed sequential method, just don't pass evidence, and set start_end_updata to False. Happy KAMLAGIRI !!
            For our method:
                score: s_t
                evidence: beta_t
        """
