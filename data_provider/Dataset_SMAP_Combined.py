...
class Dataset_SMAP_Combined(Dataset):
    ...
    def __read_data__(self):
        ...
        normal_data = np.load(os.path.join(self.root_path, 'SMAP_train.npy')) 
        attack_data = np.load(os.path.join(self.root_path, 'SMAP_test.npy'))
        attack_label = np.load(os.path.join(self.root_path, 'SMAP_test_label.npy'))
