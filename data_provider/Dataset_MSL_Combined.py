...
class Dataset_MSL_Combined(Dataset):
    ...
    def __read_data__(self):
        ...
        normal_data = np.load(os.path.join(self.root_path, 'MSL_train.npy')) 
        attack_data = np.load(os.path.join(self.root_path, 'MSL_test.npy'))
        attack_label = np.load(os.path.join(self.root_path, 'MSL_test_label.npy'))
